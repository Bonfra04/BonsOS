...
#define PORTSC_RESUME_DETECT    (1 << 6)
#define PORTSC_LOW_SPEED        (1 << 8)
#define PORTSC_PORT_RESET       (1 << 9)

#define PORTSC_RESET_MASK ~(PORTSC_STATUS_CHANGE | PORTSC_ENABLE | PORTSC_ENABLE_CHANGE | PORTSC_RESUME_DETECT | PORTSC_LOW_SPEED | PORTSC_PORT_RESET)
...
#define UHCI_PCI_DISABLE_LEGSUP 0x8F00
